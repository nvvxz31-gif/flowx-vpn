      ...
      >
        <div className="flex items-center gap-4 mb-5">
          ...
          <div>
            ...
            >
              {t(lang, 'trialPeriod')} · 5 {lang === 'en' ? 'days' : 'дней'}
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-3">
          {[
            { IconComp: Hash, label: t(lang, 'userId'), value: '1 284 930' },
            { IconComp: User, label: t(lang, 'telegram'), value: '@username' },
            { IconComp: Mail, label: t(lang, 'email'), value: 'user@example.com', editable: true },
            { IconComp: Calendar, label: t(lang, 'registered'), value: lang === 'en' ? 'May 14, 2026' : '14 мая 2026' },
      ...
      >
        ...
        <div className="flex items-center justify-between py-2 border-b mb-3" style={{ borderColor: rowBorder }}>
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm font-medium" style={{ color: primaryText }}>{t(lang, 'trialPeriod')}</span>
          </div>
        </div>
        <div className="flex items-center justify-between py-2">
          <span className="text-sm" style={{ color: secondaryText }}>{t(lang, 'expires')}</span>
          <span className="text-sm font-medium font-mono" style={{ color: primaryText }}>{lang === 'en' ? 'May 19, 2026' : '19 мая 2026'}</span>
        </div>
      </motion.div>
