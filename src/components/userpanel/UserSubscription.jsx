...
// ✅ SECURITY NOTE: цены только для UI. При подключении кассы —
// передавать { plan_id: 'basic', months } на бэкенд, получать сумму оттуда.
const durations = [
    ...
    <div className="p-6 md:p-8">
      ...
      >
        <div className="flex items-start justify-between mb-4">
          ...
          <span className="text-xs px-3 py-1 rounded-full font-semibold" style={{ background: 'rgba(48,209,88,0.15)', color: '#30D158' }}>
            Активен
          </span>
        </div>
        <div className="grid grid-cols-3 gap-4">
          {[
            { label: 'Трафик', value: '∞ ГБ' },
      ...
      <motion.div
        ...
        style={{ background: 'rgba(28,28,30,0.6)', border: '1px solid rgba(255,255,255,0.07)' }}
      >
        <div className="flex items-center justify-between mb-3">
          <span className="text-base font-bold" style={{ color: '#F5F5F7' }}>Basic</span>
          <div className="text-right">
            <span className="text-2xl font-bold" style={{ color: '#F5F5F7' }}>₽ {selected.price}</span>
              ...
              {d.discount && (
                <div
                  ...
                  style={{
                    ...
                    color: 'white', fontSize: '9px', padding: '2px 6px',
                    whiteSpace: 'nowrap', borderRadius: '100px',
                  }}
                >
                  -{d.discount}%
                </div>
