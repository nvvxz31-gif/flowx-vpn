...
export default function UserConnect() {
  ...
  return (
    <div className="p-4 md:p-8">
      ...
      {/* Config string */}
      <motion.div initial={{ opacity: 0, y: 15 }} animate={{ opacity: 1, y: 0 }} className="glass-card p-5 rounded-2xl mb-4">
      ...
      {/* QR code */}
      <motion.div initial={{ opacity: 0, y: 15 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.05 }} className="glass-card p-5 rounded-2xl mb-4">
      ...
      {/* Platform selector */}
      <motion.div initial={{ opacity: 0, y: 15 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }} className="glass-card p-5 rounded-2xl mb-4">
